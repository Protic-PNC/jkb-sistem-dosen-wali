<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10">
        ...
        @role('admin')
            ...
            <a class="flex items-center px-6 py-2 mt-4 {{ setActive('masterdata.programs.*') }}"
                href="{{ route('masterdata.programs.index') }}">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
            ...
            <a class="flex items-center px-6 py-2 mt-4 {{ setActive('masterdata.khs.*') }}"
                href="{{ route('masterdata.khs.index') }}">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z">
                ...
                <span class="mx-3">KHS</span>
            </a>
            <a class="flex items-center px-6 py-2 mt-4 {{ setActive('masterdata.krs.*') }}"
                href="{{ route('masterdata.krs.index') }}">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z">
        ...
        @role('dosenWali')
            ...
            <a class="flex items-center px-6 py-2 mt-4 {{ setActive('masterdata.gpas.*') }}"
                ...
                <span class="mx-3">Nilai Mahasiswa</span>
            </a>
            ...
            <a class="flex items-center px-6 py-2 mt-4 {{ setActive('masterdata.scholarships.*') }}"
                href="{{ route('masterdata.scholarships.index') }}">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z">
...
{{-- <aside
    class=" h-full pb-10 flex flex-col max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Siwali JKB</span>
        </a>
    </div>

    <hr class="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />

    <div class="flex flex-grow max-h-screen overflow-y-auto">
        <div class="items-center block w-auto grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('dashboard.index') }}py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colorsz"
                        href="{{ route('dashboard.index') }}">
                        <div
                ...
                @role('admin')
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('masterdata.users.*') }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colorsz"
                        href="{{ route('masterdata.users.index') }}">
                        <div
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('masterdata.programs.*') }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('masterdata.programs.index') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('masterdata.student_classes.*') }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('masterdata.student_classes.index') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Student Classes</span>
                    </a>
                </li>
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('masterdata.students.*') }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('masterdata.students.index') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('masterdata.lecturers.*') }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('masterdata.lecturers.index') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Lecturers</span>
                    </a>
                </li>
                <li class="mt-0.5 w-full">
                    <a class="{{ setActive('masterdata.reports.*') }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        href="{{ route('masterdata.reports.index') }}">
                        <div
                            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
