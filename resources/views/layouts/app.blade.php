                            ...
                            <nav class="flex" aria-label="Breadcrumb">
                                <ol class="inline-flex items-center ">
                                    ...
                                    <li aria-current="page">
                                        <div class="flex items-center">
                                            <a href="{{ route('dashboard.index') }}"
                                                class="hover:text-blue-600 hover:text-blue-600 text-sm font-medium text-gray-500 dark:text-gray-400">Master
                                                Data</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex items-center">
                                            <span
                                                class=" text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400 dark:hover:text-white">@yield('descendant_folder')</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex items-center">
    ...
    <footer class=" mt-10 bg-gray-200 dark:bg-gray-800 w-full absolute bottom-0 ">
        <div class="w-full mx-auto max-w-screen-xl p-4 flex items-center justify-end">
            <span class="text-sm text-gray-500 text-center dark:text-gray-400">
                © 2024 <a href="https://github.com/Rayhan-Afrizal-Fajri" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:underline">Rayhan Afrizal Fajri</a>. All Rights
                Reserved.
            </span>
        </div>
    </footer>
