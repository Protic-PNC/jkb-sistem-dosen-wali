                ...
                <tbody>
                    @foreach ($program as $data)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('masterdata.programs.edit', $data->program_id) }}"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                <button
                                    onclick="confirmDelete('{{ route('masterdata.programs.destroy', $data->program_id) }}')"
                                    type="button"
            ...
            <div id="alert-additional-content-2"
                ...
                <div class="flex">
                    <form id="deleteForm" method="post"
                        action="{{ route('masterdata.programs.destroy', $data->program_id ?? '') }}">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
