            ...
            <div class="max-w-7xl sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Beasiswa</h2>
                        <form method="POST" action="{{ route('masterdata.scholarships.store') }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-2 mt-3">
                                                ...
                                                <div class="flex-grow">
                                                    <label for="name"
                                                        ...
                                                        Beasiswa</label>
                                                        <input type="text" name="scholarship_type" id="name"
