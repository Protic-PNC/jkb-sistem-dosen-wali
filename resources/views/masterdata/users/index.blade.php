                    ...
                    @foreach ($user as $data)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button @if ($data->name == 'admin')
                                    hidden
                                @endif onclick="confirmDelete('{{ route('masterdata.users.destroy', $data->id) }}')" type="button" class="font-medium text-red-600 dark:text-blue-500 hover:underline">Hapus</button>
                            </td>
                        </tr>
                    @endforeach
                @else
