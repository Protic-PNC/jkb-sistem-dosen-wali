<x-app-layout>
    ...
    @section('descendant_folder', '/ Dosen Wali') --}}

    @section('content')
        <section class="bg-white dark:bg-gray-900">
            <div class="py-4 px-2 mx-auto lg:m-8 sm:m-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4 ">Data Dosen Wali</h3>
            ...
            <div class="px-8 pb-8 -mt-20 relative">
                <div class="flex flex-col md:flex-row items-center md:items-end mb-6 mt-6">
                    ...
                    <div class="text-center md:text-left">
                        <h2 class="text-3xl font-bold text-gray-800 dark:text-white">{{ $lecturer->lecturer_name }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                        ...
                        <p class="text-gray-950 dark:text-gray-400">{{ $lecturer->lecturer_address }}</p>
                    </div>
                    <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                        <h3 class="text-lg font-semibold text-gray-950 dark:text-gray-200 mb-2">No Telefon</h3>
                        <p class="text-gray-950 dark:text-gray-400">{{ $lecturer->lecturer_phone_number }}</p>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap justify-between items-center">
                    <div class="flex space-x-3 mb-4 md:mb-0">
                        ...
                        <a href="{{ route('masterdata.lecturers.edit', $lecturer->lecturer_id) }}">
                            <button
