            ...
            <div class="max-w-7xl sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Peringatan</h2>
                        <form method="POST" action="{{ route('masterdata.warnings.update', $warningDetail->warning_detail_id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="guidance-entry">
                                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                        <div class="w-full">
                                            <div class="">
                                                <label for="select_program"
                                                    ...
                                                    Mahasiswa</label>
                                                    <input type="text" name="student" id="name" value="{{ $warningDetail->student->student_name }}" disabled
                                            ...
                                            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-2 mt-3">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <select id="select_program" name="warning_type"
                                                        ...
                                                        <option @selected($warningDetail->warning_type == 'SP 1') value="SP 1">SP 1</option>
                                                        <option @selected($warningDetail->warning_type == 'SP 2') value="SP 2">SP 2</option>
                                                        <option @selected($warningDetail->warning_type == 'SP 3') value="SP 3">SP 3</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="w-full">
                                            ...
                                            <input type="text" name="reason" id="name" value="{{ $warningDetail->reason }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Alasan dikenai surat peringatan" required="">
                                        </div>
                                    </div>
