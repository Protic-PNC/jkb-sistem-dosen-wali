                    ...
                    <tbody>
                        @foreach ($students as $student)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                @for ($i = 1; $i <= $jumlahSemester; $i++)
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-b">{{ $student->gpa_cumulative->gpa_semester->semester_gpa ?? '-' }}</td>
                                @endfor
                                <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-b">{{ $student->gpa_cumulative->cumulative_gpa ?? '-' }}</td>
