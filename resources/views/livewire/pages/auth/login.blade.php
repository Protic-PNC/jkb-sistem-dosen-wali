...
<div>
    ...
    <form wire:submit="login">
        ...
        <x-primary-button wire:loading.attr='disabled' wire:loading.remove>
            {{ __('Log in') }}
        </x-primary-button>
        <x-primary-button wire:loading wire:cloack disabled wire:target='login'>
        ...
        {{-- <div role="status" class="ml-2">
            <svg wire:loading.inline wire:target="login" wire:cloak aria-hidden="true" class=" w-6 h-6 text-gray-300 animate-spin fill-blue-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
